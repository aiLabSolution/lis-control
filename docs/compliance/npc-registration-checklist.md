...
> **⮕ TOPOLOGY DECISION (2026-06-24) — [ADR-0004](../adr/0004-deployment-topology.md); resolves decision #3.** The
...
>
> **Topology framing (ADR-0004).** At the **M1 pilot**, LabSolution holds no PHI, so the only DPA LabSolution needs
...
| H1 | **Cloud host** — ⛔ **PARKED: M2 (public cloud) not selected (ADR-0004).** Not applicable to the M1 pilot or the M3 own-datacenter spoke. Revisit only if a future customer requires cloud residency. | `[PARKED]` | Counsel + DPO | (n/a unless M2 revived) | REQ-PRIV-09, REQ-PRIV-08 |
