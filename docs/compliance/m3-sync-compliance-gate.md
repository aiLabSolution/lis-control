...
> [ADR-0002](../adr/0002-deployment-topology.md)). It is **not formal legal advice.**

---

## 0. Why this gate exists

Per **ADR-0002**, the committed roadmap is:
...
- **DEC-03 (topology)** — resolved by ADR-0002 (M1 pilot; M3 spoke; M2 parked). This gate is the
  consequence.
...
- [ADR-0002](../adr/0002-deployment-topology.md) — the topology decision this gate implements.
