...
`docs/adr/0006-deployment-topology.md`) live outside `docs/compliance/` and are **not** mirrored
...
> ([ADR-0006](../adr/0006-deployment-topology.md)) revised **every** mirrored compliance doc and
> added two new docs.
